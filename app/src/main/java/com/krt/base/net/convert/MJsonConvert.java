package com.krt.base.net.convert;
...
import com.krt.base.net.SimpleResponse;
    ...
    private T parseParameterizedType(Response response, ParameterizedType type) throws Exception {
        ...
        if (rawType != Result.class) {
            ...
            if (typeArgument == Void.class) {
                ...
                if (!result.isSuccess()) {
//                    EventBus.getDefault().post(new MEventBean(BaseMessageWrap.ACTION_RESULT_CODE, result.code));
                }
                //noinspection unchecked
                return (T) result;
//            } else{
